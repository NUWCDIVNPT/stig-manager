  ...
  function dmlObjectFromAppData (appdata) {
    ...
    let dml = {
      ...
      postload: [
        ...
        `ALTER TABLE STIGMAN.ASSET_COLLECTION_MAP MODIFY APID GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE)`,
        `ALTER TABLE STIGMAN.ASSETS MODIFY ASSETID GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE)`,
        `ALTER TABLE STIGMAN.COLLECTIONS MODIFY COLLECTIONID GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE)`,
      ...
      collections: {
        sqlDelete: `DELETE FROM stigman.collections`,
      ...
      assetCollectionMap: {
        sqlDelete: `DELETE FROM stigman.asset_collection_map`,
        sqlInsert: `INSERT INTO stigman.asset_collection_map (
          assetId,
          collectionId
        ) VALUES (
    ...
    dml.collections.insertBinds = collections
    ...
    for (const asset of assets) {
      let { collectionIds, stigGrants, ...assetFields} = asset
      ...
      for (const collectionId of collectionIds) {
        dml.assetCollectionMap.insertBinds.push([assetId, collectionId])
      }
