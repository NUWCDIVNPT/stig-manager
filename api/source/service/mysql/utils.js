...
module.exports.updateStatsAssetStig = async function(connection, { collectionId, assetId, benchmarkId, rules }) {
  ...
  VALUES ? 
    on duplicate key update
      ...
      saved = VALUES(saved),
      savedResultEngine = VALUES(savedResultEngine),
      submitted = VALUES(submitted),
      submittedResultEngine = VALUES(submittedResultEngine),
      rejected = VALUES(rejected),
      rejectedResultEngine = VALUES(rejectedResultEngine),
      accepted = VALUES(accepted),
      acceptedResultEngine = VALUES(acceptedResultEngine),
      highCount = VALUES(highCount),
      mediumCount = VALUES(mediumCount),
      lowCount = VALUES(lowCount),

      notchecked  = VALUES(notchecked),
      notcheckedResultEngine = VALUES(notcheckedResultEngine),
      notapplicable = VALUES(notapplicable),
      notapplicableResultEngine = VALUES(notapplicableResultEngine),
      pass = VALUES(pass),
      passResultEngine = VALUES(passResultEngine),
      fail = VALUES(fail),
      failResultEngine = VALUES(failResultEngine),
      unknown = VALUES(unknown),
      unknownResultEngine = VALUES(unknownResultEngine),
      error = VALUES(error),
      errorResultEngine = VALUES(errorResultEngine),
      notselected = VALUES(notselected),
      notselectedResultEngine = VALUES(notselectedResultEngine),
      informational = VALUES(informational),
      informationalResultEngine = VALUES(informationalResultEngine),
      fixed = VALUES(fixed),
      fixedResultEngine  = VALUES(fixedResultEngine)
  `
