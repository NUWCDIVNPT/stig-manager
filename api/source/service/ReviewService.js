...
from
  ...
  set
    ...
    r.detailClassification = vr.detailClassification,
    r.commentClassification = vr.commentClassification,
...
exports.getReviews = async function ({projections = [], filter = {}, grant}) {
  ...
  const columns = [
    ...
    'r.detailClassification',
    'r.commentClassification',
    'r.autoResult',
...
FROM
  JSON_TABLE(
    ...
    detail MEDIUMTEXT PATH "$.detail" NULL ON EMPTY,
    comment MEDIUMTEXT PATH "$.comment",
    detailClassification VARCHAR(10) PATH "$.detailClassification",
    commentClassification VARCHAR(10) PATH "$.commentClassification",
...
select
  ...
  COALESCE(cteIncoming.detailClassification, review.detailClassification) as detailClassification,
  COALESCE(cteIncoming.commentClassification, review.commentClassification) as commentClassification,
