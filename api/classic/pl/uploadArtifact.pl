#!/usr/bin/perl
# $Id: uploadArtifact.pl 807 2017-07-27 13:04:19Z csmig $
...
#$rv = $dbh->do($sqlSetContent,undef,($importSha1,$importData,$userId));
#$rv = $dbh->do($sqlSetArtifact,undef,($importSha1,$importFilename,$desc,$userId,$userDept));
if ($rv) {
