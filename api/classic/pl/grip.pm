#!/usr/bin/perl
# $Id: grip.pm 8 2013-03-21 18:13:21Z csmig $
#=========================================================
#GRIP.PM
...
#	Authors: 	Micah, Carl Smigielski, Brandon Massey
#=========================================================
package grip;
use strict;
use Exporter;
...
sub gripDbh { 
    ...
    my $host = $ENV{"STIGMAN_ORACLE_HOST"} ? $ENV{"STIGMAN_ORACLE_HOST"} : "192.168.1.155";;
    my $port = $ENV{"STIGMAN_ORACLE_PORT"} ? $ENV{"STIGMAN_ORACLE_PORT"} : "1521";
    my $db = $ENV{"STIGMAN_ORACLE_SID"} ? $ENV{"STIGMAN_ORACLE_SID"} : "orclpdb1.localdomain" ;
