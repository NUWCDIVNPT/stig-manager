.. STIG Manager documentation master file, created by
...
.. ATTENTION::
   STIG Manager OSS is in Beta. Suggested for early adopters intending to pilot or evaluate the tool and provide feedback regarding it's utility as part of the RMF Process.
