...
//   fontRem: font-size of the clamped cell text, a TEXT_SCALE_REM step. The grid binds it as
...
export const GRID_GEOMETRY = {
  'asset-review-checklist': { defaultLineClamp: 3, fontRem: TEXT_SCALE_REM.lg, padRem: 0.4, minRem: 2.2 },
  'collection-checklist': { defaultLineClamp: 2, fontRem: TEXT_SCALE_REM.lg, padRem: 0.4, minRem: 2.2 },
  'collection-rule-table': { defaultLineClamp: 1, fontRem: TEXT_SCALE_REM.lg, padRem: 0.4, minRem: 2.4 },
  'findings-aggregated': { defaultLineClamp: 2, minLineClamp: 2, fontRem: TEXT_SCALE_REM.md, padRem: 0.67, minRem: 2.2 },
  'findings-individual': { defaultLineClamp: 2, minLineClamp: 2, fontRem: TEXT_SCALE_REM.md, padRem: 0.67, minRem: 2.4 },
  'stig-library-benchmarks': { defaultLineClamp: 2, fontRem: TEXT_SCALE_REM.md, padRem: 0.54, minRem: 1.9 },
  'stig-library-rules': { defaultLineClamp: 2, fontRem: TEXT_SCALE_REM.md, padRem: 0.54, minRem: 2.2 },
}
