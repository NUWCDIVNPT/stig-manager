...
--------------------------------------------------------
  ...
  ALTER TABLE "STIGMAN"."USER_STIG_ASSET_MAP" MODIFY ("USERID" NOT NULL ENABLE);
  ALTER TABLE "STIGMAN"."USER_STIG_ASSET_MAP" MODIFY ("SAID" NOT NULL ENABLE);
