      ...
      const tpl = new Ext.XTemplate(
          ...
          `<div class='sm-home-widget-text'>`,
            `<div class=sm-home-widget-image-text-wrap>`,
              `<img src="${STIGMAN.Env.welcome.image ? STIGMAN.Env.welcome.image : 'img/navy.svg'}" onerror="this.onerror=null;this.src='img/navy.svg';" style="max-width:100%;max-height:100%;"/>`,
            `</div>`,
